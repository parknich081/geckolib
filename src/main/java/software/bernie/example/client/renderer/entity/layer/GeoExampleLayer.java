...
public class GeoExampleLayer<T extends LivingEntity> extends GeoLayerRenderer<T> {
	...
	public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, T entityLivingBaseIn,
		...
		this.getRenderer()
				.render(getEntityModel().getModel(entityLivingBaseIn), entityLivingBaseIn, partialTicks, cameo, matrixStackIn, bufferIn, bufferIn.getBuffer(cameo), packedLightIn, OverlayTexture.NO_OVERLAY, 1f, 1f, 1f, 1f);
